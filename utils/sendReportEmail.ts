...
async function sendReportEmail() {
    ...
    try {
        ...
        // ✅ No retry loop needed — this runs AFTER playwright test fully exits,
        // so Monocart has 100% finished writing by this point, guaranteed.
                ...
                body: {
                    ...
                    content: `
                        ...
                        <table border="1" cellpadding="8" cellspacing="0">
                            <tr><td><b>Project</b></td><td>Tracsens Playwright Automation</td></tr>
                            <tr><td><b>Executed On</b></td><td>${new Date().toLocaleString()}</td></tr>
                            <tr><td><b>Browser</b></td><td>Chromium (Chrome)</td></tr>
                            <tr><td><b>Environment</b></td><td>https://prod.tracsens.com</td></tr>
                        </table>
                        <br/>
