...
- Name: administration.spec.ts >> Negative - Admin Customer Tests >> Negative Customer - Invalid email format
- Location: tests\tracsensTest\administration.spec.ts:216:13
...
Call log:
  - waiting for locator('//a[contains(@class,"sidebar-link")]//span').first() to be visible
    62 × locator resolved to hidden <span>Home</span>
